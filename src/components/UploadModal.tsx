...
export default function UploadModal({ onClose, onUploaded }: UploadModalProps) {
  ...
  const [autoGeneratedThumbs, setAutoGeneratedThumbs] = useState<string[]>([]);
  ...
  ---------------------------------- */
  const extractFrames = useCallback((videoFile: File) => {
        ...
        <div className="w-full md:w-[340px] bg-[#0a0000]/40 p-6 border-r border-white/5 hidden md:flex flex-col">
          <div className="flex items-center gap-3 mb-8">
            <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <div className="w-10 h-10 md:w-12 md:h-12 bg-red-500 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg shadow-red-500/20">
              ...
              {/* Text Section */}
              <div>
                <h1 className="text-sm md:text-lg font-black tracking-wider uppercase leading-none">
                  <span className="text-white">Air</span>
                  <span className="text-red-500">Stream</span>
                  <span className="text-white">X</span>
                </h1>
                <p className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mt-0.5">Upload Studio</p>
              </div>
            </Link>
          </div>
          ...
          <div className="mt-auto p-4 bg-[#110000]/50 rounded-2xl border border-white/5">
            ...
            <p className="text-[10px] text-zinc-500 leading-relaxed">
              By uploading, you agree to our Terms of Service and Community Guidelines. Max file size: 500 MB now.
            </p>
          </div>
        </div>
                        ...
                        <div className="flex justify-between text-xs">
                          ...
                          {titleSuggestions.length > 0 && (
                            <button
                              ...
                              className="text-red-500 hover:text-red-500 flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              {generatingAI ? (
              ...
              {step === 2 && (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Suggested Tags */}
                    {!generatingAI && suggestedTags.length > 0 && (
